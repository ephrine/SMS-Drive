...
{
  /** Default implementation for IAPConnector. */
  public static class Default implements com.samsung.android.iap.IAPConnector
  {
  ...
  public static abstract class Stub extends android.os.Binder implements com.samsung.android.iap.IAPConnector
  {
    ...
    private static class Proxy implements com.samsung.android.iap.IAPConnector
    {
      ...
      @Override public boolean requestCmd(com.samsung.android.iap.IAPServiceCallback callback, android.os.Bundle bundle) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_requestCmd, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().requestCmd(callback, bundle);
          }
      ...
      @Override public android.os.Bundle getProductsDetails(java.lang.String packageName, java.lang.String itemIds, int pagingIndex, int mode) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeInt(mode);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getProductsDetails, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getProductsDetails(packageName, itemIds, pagingIndex, mode);
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
      ...
      @Override public android.os.Bundle getOwnedList(java.lang.String packageName, java.lang.String itemType, int pagingIndex, int mode) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeInt(pagingIndex);
          _data.writeInt(mode);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getOwnedList, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getOwnedList(packageName, itemType, pagingIndex, mode);
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
            _result = android.os.Bundle.CREATOR.createFromParcel(_reply);
      ...
      @Override public android.os.Bundle consumePurchasedItems(java.lang.String packageName, java.lang.String purchaseIds, int mode) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeInt(mode);
          boolean _status = mRemote.transact(Stub.TRANSACTION_consumePurchasedItems, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().consumePurchasedItems(packageName, purchaseIds, mode);
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
            _result = android.os.Bundle.CREATOR.createFromParcel(_reply);
      ...
      @Override public android.os.Bundle requestServiceAPI(java.lang.String packageName, java.lang.String requestId, java.lang.String extraData) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_requestServiceAPI, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().requestServiceAPI(packageName, requestId, extraData);
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
            _result = android.os.Bundle.CREATOR.createFromParcel(_reply);
      ...
      public static com.samsung.android.iap.IAPConnector sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(com.samsung.android.iap.IAPConnector impl) {
    ...
    public static com.samsung.android.iap.IAPConnector getDefaultImpl() {
