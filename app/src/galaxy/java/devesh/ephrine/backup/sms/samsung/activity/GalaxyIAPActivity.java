package devesh.ephrine.backup.sms.samsung.activity;
...
public class GalaxyIAPActivity extends Activity {
    private static OperationMode IAP_MODE = OperationMode.OPERATION_MODE_PRODUCTION;
    private final String TAG = GalaxyIAPActivity.class.getSimpleName();
    ...
    public void onClick(View _view) {
        ...
        switch (_view.getId()) {
            ...
            case R.id.buttonProductsDetails: {
                Intent intent = new Intent(GalaxyIAPActivity.this,
